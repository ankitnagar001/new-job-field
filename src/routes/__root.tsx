...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LeadPilot — Find Businesses Without Websites" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "LeadPilot" },
      { property: "og:title", content: "LeadPilot — Website-Less Business Finder" },
      {
        property: "og:description",
        content: "Discover local businesses missing a website. Send personalized WhatsApp outreach in seconds.",
      },
